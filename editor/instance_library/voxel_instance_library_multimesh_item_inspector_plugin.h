...
class VoxelInstanceLibraryMultiMeshItemInspectorPlugin : public godot::ZN_EditorInspectorPlugin {
	GDCLASS(VoxelInstanceLibraryMultiMeshItemInspectorPlugin, godot::ZN_EditorInspectorPlugin)
public:
