...
class VoxelBlockyTypeLibraryEditorInspectorPlugin : public godot::ZN_EditorInspectorPlugin {
	GDCLASS(VoxelBlockyTypeLibraryEditorInspectorPlugin, godot::ZN_EditorInspectorPlugin)
public:
