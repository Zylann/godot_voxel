...
class VoxelBlockyModelEditorInspectorPlugin : public godot::ZN_EditorInspectorPlugin {
	GDCLASS(VoxelBlockyModelEditorInspectorPlugin, godot::ZN_EditorInspectorPlugin)
public:
