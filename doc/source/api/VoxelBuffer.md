...
Overwrites the contents of a channel from raw voxel data. Check [VoxelBuffer.Depth](VoxelBuffer.md#enumerations) for information about the expected data format.
