...
extern const VOX_Vector3i g_side_normals[SIDE_COUNT];
...
extern const VOX_Vector3i g_corner_inormals[CORNER_COUNT];

extern const VOX_Vector3i g_edge_inormals[EDGE_COUNT];

extern const unsigned int g_edge_corners[EDGE_COUNT][2];

const unsigned int MOORE_NEIGHBORING_3D_COUNT = 26;
extern const VOX_Vector3i g_moore_neighboring_3d[MOORE_NEIGHBORING_3D_COUNT];

const unsigned int MOORE_AREA_3D_COUNT = 27;
const unsigned int MOORE_AREA_3D_CENTRAL_INDEX = 13;
extern const VOX_Vector3i g_ordered_moore_area_3d[MOORE_AREA_3D_COUNT];
