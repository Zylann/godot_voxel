...
Ref<VoxelGraphFunction> VoxelGeneratorGraph::get_main_function() const {
...
static bool has_output_type(
		const VoxelGraphRuntime &runtime, const ProgramGraph &graph, VoxelGraphFunction::NodeTypeID node_type_id) {
