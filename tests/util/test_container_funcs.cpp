...
void test_unordered_remove_if() {
	...
	// Remove one at beginning
	{
		...
		unordered_remove_all_if(vec, [](int v) { return v == 0; });
	...
	// Remove one in middle
	{
		...
		unordered_remove_all_if(vec, [](int v) { return v == 2; });
	...
	// Remove one at end
	{
		...
		unordered_remove_all_if(vec, [](int v) { return v == 3; });
	...
	// Remove multiple
	{
		...
		unordered_remove_all_if(vec, [](int v) { return v == 1 || v == 2; });
